...
export const ETHERSCAN_API_KEY = process.env["POLYGONSCAN_API"] || ""
export const MUMBAI_MNEMONIC = process.env["ALFA_PRIVATEKEY"] || ""
export const MUMBAI_URL = process.env["POLYGONPoS_URL"] || ""
export const POLYGONPoS_MNEMONIC = process.env["ALFA_PRIVATEKEY"] || ""
export const POLYGONPoS_URL = process.env["POLYGONPoS_URL"] || ""
export const ALFAJORES_MNEMONIC = process.env["ALFA_PRIVATEKEY"] || ""
